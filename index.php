...
<body>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>
            Hey there! I'm Lee Weng Hin, a software engineer with a passion for crafting innovative digital solutions. I
            believe that every project is an opportunity to create something exceptional and meaningful. With a strong
            foundation in web development. I am eager to apply my knowledge and learn through real-world experiences
            during my upcoming internship. While I may not have professional experience yet, I am enthusiastic about
            contributing to a diverse range of projects and expanding my skills to embrace new challenges.
            <!-- I've had the privilege of contributing to a diverse range of projects. These opportunities have allowed me to develop and apply my skills while fostering my passion for innovation and creativity. -->
          </p>
        </div>
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <!-- <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                    <span>https://leewenghin.github.io/</span>
                  </li> -->
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <a href="tel: +60 16 308 6381">+60 16
                      308 6381</a></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Kuala Lumpur</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
    ...
    <section id="skills" class="skills section-bg">
      <div class="container">
        ...
        <div class="row skills-content pb-3">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          <a href="assets/img/leewenghin_CV.pdf" download class="download-btn">
            <button type="button" class="btn btn-primary">Download CV <i class="fa fa-download"></i></button>
          </a>
        </div>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-practices">Practices</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-projects">
            <a class="text-dark" href="week8_assignment1/index.html" title="More Details" target="_blank">
              <div class="portfolio-wrap">
                <img src="week8_assignment1/img/assignment-img.png" class="img-fluid" alt="">
              </div><br>Portfolio
            </a>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-projects">
            <a class="text-dark" href="week12_assignment2/index.html" title="More Details" target="_blank">
              <div class="portfolio-wrap">
                <img src="assets/img/group-assignment-cover.png" class="img-fluid" alt="">
              </div><br>Traveling
            </a>
          </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <!-- <p>I'm happy to answer your questions. Fill out the form and I'll be in touch as soon as possible.</p> -->
          <p>Currently the contact form on this website is not available, if you wish to get in touch with me, please
            feel free to reach out via dominicleewenghin@gmail.com. I look forward to hearing from you.</p>
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>No.7-2F, Jalan 5/154D, Taman Desa Cheras, 56000 KL</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>dominicleewenghin@gmail.com</p>
              </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Dominic's Profile</span></strong>
      </div>
      <div class="credits">
